...
async def on_ready():
    ...
    scheduler.add_job(request_papers, CronTrigger(day_of_week='mon', hour=11, minute=0, second=0))
    scheduler.add_job(create_poll, CronTrigger(day_of_week='thu', hour=9, minute=0, second=0))
    scheduler.start()
